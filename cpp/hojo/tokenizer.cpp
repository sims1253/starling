// tokenizer.cpp — Qwen3 BPE byte-decoder (identical scheme to moss/ark/higgs).
// Verbatim copy of higgs/tokenizer.cpp with the namespace renamed; the GPT-2
// byte-to-unicode inverse map is model-agnostic. Hojo's tokenizer is a standard
// Qwen3 tokenizer stored in the GGUF (vocab 151670, resized embeddings).
