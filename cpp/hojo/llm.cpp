...
// (A 4-beam-bundled variant of this graph measured no faster than the
// per-beam one-shot: the step cost is dominated by per-beam kernel launches +
// host ranking, not graph setup.)
// ---------------------------------------------------------------------------
