...
// Qwen3 BPE byte-decoder (same GPT-2 scheme as moss/ark/higgs). The GGUF
// carries the full 151670-entry tokenizer table; decode maps token -> UTF-8
// text via the GPT-2 byte-to-unicode inverse.
class Tokenizer {
public:
