...
// Defaults are model-specific (max_cache_len 4096 for qwen3-asr).
struct GenerateOptions {
    int32_t max_new_tokens = 200, max_cache_len = 4096, eos_token_id = 151645;
};
bool llm_prefill(const Qwen3Model&, const InputsEmbeds&, int32_t max_cache_len,
                 PrefillResult&, std::string&);
bool greedy_generate(const Qwen3Model&, const InputsEmbeds&, const GenerateOptions&,
