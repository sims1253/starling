...
core imports.  Triton is only installed and verified on Linux. Other platforms use
the CUDA or torch backend.
...
def main() -> int:
    ...
    parser.add_argument("--python", default="3.10", help="Python version for the venv")
    ...
    # Match the Linux-only Triton dependency in pyproject.toml.
