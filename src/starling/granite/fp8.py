"""FP8 (e4m3) weight-only quantization for the Granite-4.0-1b decoder GEMVs.
...
The **lm_head is deliberately kept in bf16** -- its 100353-way argmax has
near-tie logits that fp8 rounding can flip, changing the transcript.  Only the
40 decoder layers' projections are quantized.  See
